    ...
    <div>
      ...
      <div className="team-info">
          ...
          <div className="row m-5 container d-flex justify-content-center align-items-center team-detail">
            <div className="p-4 col-md-7">
              ...
              <div className="d-flex mt-2">
                ...
                <p>
                  <strong>Sports Type: {strSport}</strong>
                </p>
              </div>
              <div className="d-flex mt-2">
            ...
            <div className="col-md-5 p-4">
              {strGender === "Male" ? (
                <img className="w-100" src={maleImage} alt="" />
              ) : (
                <img className="w-100" src={femaleImage} alt="" />
              )}
            </div>
          </div>
        </div>
        <div className="description-container d-flex justify-content-center align-items-center">
          <div className="row p-1 container ">
            <div className="col-md-12">
              <p className="team-description text-justify">
                {strDescriptionEN}
              </p>
            </div>
          </div>
        ...
        <div className="description-container d-flex justify-content-center align-items-center">
          <div className="row p-1 container ">
            <div className="col-md-12">
              <p className="stadium-description text-justify">
                {strStadiumDescription}
              </p>
            </div>
          </div>
